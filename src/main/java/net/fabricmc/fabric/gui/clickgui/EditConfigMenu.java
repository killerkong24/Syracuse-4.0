...
public class EditConfigMenu extends net.fabricmc.fabric.gui.clickgui.components.Component {

    private final ConfigScreen parent;
    private final Animation animation;
    private final net.fabricmc.fabric.gui.clickgui.components.TextComponent nameText;
    private final net.fabricmc.fabric.gui.clickgui.components.TextComponent descriptionText;
    ...
    public EditConfigMenu(ConfigScreen parent, Config editing) {
        ...
        nameText = new net.fabricmc.fabric.gui.clickgui.components.TextComponent(parent.parent, editing.getName());
